...
export default class MultiSlider extends React.Component {
  ...
  touchLeftTrack = e => {
    const confined = e.nativeEvent.locationX;
    var value = positionToValue(
      confined,
      this.optionsArray,
      this.props.sliderLength
  ...
  touchRightTrack = e => {
    const confined = this.state.positionOne + e.nativeEvent.locationX;
    var value = positionToValue(
      confined,
      this.optionsArray,
      this.props.sliderLength
    ...
    return (
      <View style={containerStyle}>
        <View style={[styles.fullTrack, { width: sliderLength }]}>
          <TouchableWithoutFeedback onPress={this.touchLeftTrack}>
            <View
              style={[
                styles.track,
          ...
          <TouchableWithoutFeedback onPress={this.touchRightTrack}>
            <View
              style={[
                styles.track,
                this.props.trackStyle,
